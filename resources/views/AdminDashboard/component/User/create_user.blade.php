        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="container p-6 center">
                    ...
                    <div class="form mt-3">
                        <form action="{{ route('Admin.CreatUser') }}" method="post" class="needs-validation"
                            novalidate>
                            @csrf
                            <hr>
                            <div class="row mt-3">
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="UserPhone" id="validationCustom01"
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="Useremail" id="validationCustom01"
