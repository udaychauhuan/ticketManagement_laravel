        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="container p-6 center">
                    ...
                    <div class="form mt-3">
                        <form action="{{route('User.EditTicket',$ticket->id)}}" method="post" class="needs-validation" novalidate>
                            @csrf
                            <hr>
                            <div class="row mt-3">
                                <div class="col-6">
                                    <label for="validationCustom01" class="form-label">Ticket Name</label>
                                    <input type="text" class="form-control" name="TicketName" value="{{$ticket->TicketName}}" id="validationCustom01"
                                ...
                                <div class=" col- 12 mb-3 mt-3">
                                    ...
                                    <textarea class="form-control " name="TicketDiscription" rows="3" id="validationTextarea"
                                        placeholder="Enter the Discription of Ticket" required>{{$ticket->TicketDiscription}}</textarea>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                    <div class="invalid-feedback">
